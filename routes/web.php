...
function() {
	...
	Route::get('/defi', 'Web\CryptoCurrenciesController@defi');
	...
	Route::get('/fundamental-crypto-asset-score', 'Web\CryptoAssetScoreController@cryptoAssetScore');
	Route::get('/fundamental-crypto-asset-score/{alias?}', 'Web\CryptoAssetScoreController@cryptoAssetScoreDetails');

	Route::get('/crypto-dictionary', 'Web\CryptoDictionaryController@cryptoDictionary');
	Route::get('/crypto-dictionary/{term?}', 'Web\CryptoDictionaryController@cryptoDictionaryTerm');

	Route::get('/crypto-exchanges', 'Web\CryptoExchangesController@index');
	Route::get('/crypto-exchanges/{exchange}', 'Web\CryptoExchangesController@exchange');
	...
	Route::get('tag/{slug?}', 'Web\CryptoNewsController@tag');
	...
	Route::get('/fear-and-greed-index', 'Web\FearGreedController@index');
	...
	* News Page - Web\CryptoNewsController@index
	*
	*/
...
Route::get('/ajax-load-dictionary', 'Web\CryptoDictionaryController@getDictionaryTerm');
Route::get('/ajax-load-fear-greed-data/{time_frame}', 'Web\ChartsAjaxController@getFearGreedData');
