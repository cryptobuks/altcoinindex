...
Route::get('/fcas-listing', 'Api\CoinMarketCapApiController@getFcasListing');
Route::get('/crypto-icons', 'Api\CoinMarketCapApiController@cryptoIcons');

Route::get('/crypto-exchanges-data', 'Api\CryptoCompareApiController@getExchanges');

Route::get('/crypto-news-data', 'Api\CryptoNewsApiController@getNews');
Route::get('/crypto-feed-news-data', 'Api\CryptoNewsFeedAggregatorApiController@getNews');
...
Route::get('/fear-greed', 'Api\FearGreedApiController@getFearGreedIndexes');
