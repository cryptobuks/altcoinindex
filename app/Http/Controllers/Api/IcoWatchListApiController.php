...
class IcoWatchListApiController extends Controller
{
	...
	public function getICOs()
	{
        ...
        isset($icos['ico']['live']) ? $this->saveIcoData($icos['ico']['live'], 0) : '';
        isset($icos['ico']['upcoming']) ? $this->saveIcoData($icos['ico']['upcoming'], 1) : '';
        isset($icos['ico']['finished']) ? $this->saveIcoData($icos['ico']['finished'], 2) : '';
	}
