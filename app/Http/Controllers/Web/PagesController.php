...
class PagesController extends Controller
{
	...
	{
		return view(getCurrentTemplate() . '.pages.static.advertise', ['crypto_tags' => $this->getNewsTags()]);
	}

	public function contactUs()
	{	
		return view(getCurrentTemplate() . '.pages.static.contact_us', ['crypto_tags' => $this->getNewsTags()]);
	}
	...
	{
		return Tags::where('status', 1)->get();
	}
