...
.trademark a {color: #<?php echo $_GET['tcolor'] ?? '000'; ?>; text-decoration: none;}
.dark-mode-table-color {color: #<?php echo $_GET['tcolor'] ?? '000'; ?>;}
</style>
<div class="ticker">
	<table cellpadding="0" cellspacing="0" class="dark-mode-table-color">
		<thead>
			<tr>
