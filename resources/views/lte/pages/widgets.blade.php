...
$('#tab_1 .ticker-iframe').attr('src', '{{ makeUrl("widget/ticker") }}?hcolor=fff&tcolor=000');
$('#tab_1  textarea').html('<iframe src="{{ makeUrl("widget/ticker") }}?hcolor=fff&tcolor=000" style="width: 100%; overflow: hidden;scroll-behavior: unset;height: 525px;border: unset;"></iframe>');
...
$('#tab_2 .price-ticker-iframe').attr('src', '{{ makeUrl("widget/ticker/BTC") }}?hcolor=fff&tcolor=000');
$('#tab_2 textarea').html('<iframe src="{{ makeUrl("widget/ticker/BTC") }}?hcolor=fff&tcolor=000" style="width: 100%; overflow: hidden;scroll-behavior: unset;height: 525px;border: unset;"></iframe>');
</script>
@stop
@section('styles')
<style type="text/css">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control text-color">
                        <option value="ffffff">@lang('widgets.WHITE')</option>
                        <option selected="selected" value="000000">@lang('widgets.BLACK')</option>
                        <option value="d2d6de">@lang('widgets.GRAY')</option>
                      </select>
                    </div>
                    <div class="form-group">
