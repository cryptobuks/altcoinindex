        ...
        <table width="100%" class="table table-hover" id="dataTables-example">
            ...
            <tbody class="crypto-currencies-data">
                ...
                <tr class="odd gradeX">
                    ...
                    @if(isset($all_time_high_low[$market->symbol]->high) && $market->price_usd > $all_time_high_low[$market->symbol]->high)
                    <td class="all_time_high align-right" style="color: green;" val="{{{ $market->price_usd or 'N/A' }}}"></td>
                    @else
