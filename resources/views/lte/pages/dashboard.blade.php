  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box dashboard-top-boxes">
          <div class="inner">
            <h3>{{{ $crypto_globals['bitcoin_percentage_of_market_cap'] or '0' }}}%</h3>
            <p>@lang('v6.BITCOIN_SHARE')</p>
          </div>
          <div class="icon">
            <i class="fa fa-bitcoin"></i>
          </div>
          <a href="{{ makeUrl('currencies') }}" class="small-box-footer">@lang('buttons.MORE_INFO') <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
    </div>
    <div class="row">
            ...
            <div class="panel-body icos-panel-class">
              @foreach($icos as $ico)
                <div class="ico-detail-div">
                  ...
                  <img class="image" alt="{{ $ico->name }} ico" title="{{ $ico->name }} ico" src="{{URL::asset('public/storage/' . $ico->image)}}" height="60" style="float: left;margin-right: 10px;">
                  @elseif($ico->coin_image != '' && file_exists('public/images/coins_icons/' . $ico->coin_image))
                  <img class="image" alt="{{ $ico->name }} ico" title="{{ $ico->name }} ico" src="{{URL::asset('public/images/coins_icons/' . $ico->coin_image)}}" height="60" style="float: left;margin-right: 10px;">
                  @else
                  <img class="image" alt="{{ $ico->name }} ico" title="{{ $ico->name }} ico" src="{{URL::asset('public/images/default_coin.png')}}" height="60" style="float: left;margin-right: 10px;">
                  @endif
                  <p>
                    {{ str_limit($ico->description, 70) }} <br />
