...
<style type="text/css">.bsbig_fig > a img {min-height: 313px !important;}.news-page-video iframe{ text-align: center;width: 100%; height: 272px; }@media only screen and (min-width: 1650px)  {.news-wrapper {width: 80%; margin: 0 auto;}}@media only screen and (max-width: 1650px)  {.news-wrapper {width: 100%; margin: 0 auto;}}
.news-search-input{border-radius: 5px;width: 75%;float: left;margin-right: 5px;height: 32.48px;}.news-tags{text-align:center;margin-bottom: 10px;margin-top: 2px;}.news-tags a{color: white;background: black;padding: 2.2px 8px;margin-right: 0.5px;border-radius: 3px;}.search-btn {border-radius: 5px; width: 86px;}</style>
@stop
@section('scripts') 
...
<div class="news-wrapper">
  <div class="row news-tags">
    <div class="col-md-12">
      <a href="{{makeUrl('blog')}}">Blog</a>
      <a href="{{makeUrl('tag/blockchain')}}">Blockchain</a>
      @if($tags)
        @foreach($tags as $tag)
          <a title="{{ $tag->tag }}" href="{{makeUrl('tag')}}/{{ $tag->slug }}">{{ $tag->tag }}</a>
        @endforeach
      @endif
    </div>
  </div>
    ...
    <div class="col-md-8">
      <div class="slick_slider">
        @foreach($crypto_news as $news)
          @if($news['urlToImage'] != 'no_preview.png' && $news['urlToImage'] != '' )
                  ...
                  <li style="min-height: 450px;">
                    <figure class="bsbig_fig"> 
                      <a href="{{ URL::to('/crypto-news') }}/{{$magnates_news[0]['id']}}/{{$magnates_news[0]['alias']}}" class="featured_img"> 
                        ...
                        <img alt="{{{ $magnates_news[0]['title'] }}}" title="{{{ $magnates_news[0]['title'] }}}" src="{{{ URL::asset('public/storage/' . $magnates_news[0]['urlToImage']) }}}"> 
                        @else
      ...
      <div class="col-md-4">
        <aside class="right_content">
          ...
          <div class="single_sidebar wow fadeInDown">
            ...
            <ul style="background-color: white; padding: 12px;">
              <li style="padding: 3px;"><a href="{{ makeUrl('archive-news') }}">@lang('menu.ARCHIVE_NEWS')</a></li>
              <li style="padding: 3px;"><a href="{{ makeUrl('live-crypto-currencies-updates') }}">@lang('menu.COINS_LIVE_WATCH')</a></li>
              <li style="padding: 3px;"><a href="{{ makeUrl('cryptocurrency-converter') }}">@lang('menu.CONVERTER')</a></li>
              <li style="padding: 3px;"><a href="{{ makeUrl('cryptocurrency-widgets') }}">@lang('menu.WIDGETS')</a></li>
              <li style="padding: 3px;"><a href="{{ URL::to('sitemap') }}.xml">Sitemap</a></li>
            </ul>
          </div>
        </aside>
      </div>
