    ...
    <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview @if(Request::is(['*/crypto-currencies', '*/top-gainers-crypto-currencies', '*/top-losers-crypto-currencies', '*/live-crypto-currencies-updates', '*/high-low-crypto-currencies'])) active @endif"">
            ...
            <ul class="treeview-menu">
                <li><a href="{{ makeUrl('defi') }}"><i class="fa fa-ils"></i> Defi</a></li>
                <li><a href="{{ makeUrl('currencies') }}"><i class="fa fa-video-camera"></i> @lang('v7.CURRENCIES')</a></li>
        ...
        <li class="@if(Request::is('*/fear-and-greed-index')) active @endif">
            <a title="@lang('fear.FEAR_GREED_MENU')" href="{{ makeUrl('fear-and-greed-index') }}">
                <i class="fa fa-bell-o"></i> <span>@lang('fear.FEAR_GREED_MENU')</span>
            </a>
        </li>
        ...
        <li class="@if(Request::is('*/crypto-dictionary')) active @endif">
            <a title="@lang('v9.DICTIONARY')" href="{{ makeUrl('crypto-dictionary') }}">
                <i class="fa fa-book"></i> <span>@lang('v9.DICTIONARY')</span>
            </a>
        </li>
            ...
            <ul class="treeview-menu">
                ...
                <li class="@if(Request::is('*/events')) active @endif">
                    <a title="@lang('v7.EVENTS')" href="{{ makeUrl('events') }}">
                        <i class="fa fa-life-ring"></i> <span>@lang('v7.EVENTS')</span>
                    </a>
                </li>
                <li class="@if(Request::is('*/fundamental-crypto-asset-score')) active @endif">
                    <a href="{{ makeUrl('fundamental-crypto-asset-score') }}">
                        <i class="fa fa-spinner"></i> <span>@lang('v9.ASSET_SCORE')</span>
                    </a>
                </li>
                <li class="@if(Request::is('*/block-explorer')) active @endif">
                    <a href="{{ makeUrl('block-explorer') }}">
                        <i class="fa fa-bitcoin"></i> <span>@lang('menu.BLOCKEXPLORER')</span>
                    </a>
                </li>
            </ul>
        </li>
