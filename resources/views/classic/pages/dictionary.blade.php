...
@section('styles')<style type="text/css">.dictionary-search {width: 100%;position: relative;display: flex;}.searchTerm {width: 100%;border: 1px solid #00b5ad;border-right: none;padding: 22px;height: 20px;border-radius: 5px 0 0 5px;outline: none;color: #9DBFAF;font-size: 22px;margin-left: 15px;}.searchTerm:focus{color: #00b5ad;}.searchButton {width: 100px;height: 46px;border: 1px solid #00b5ad;background: #00b5ad;text-align: center;color: #fff;border-radius: 0 5px 5px 0;cursor: pointer;font-size: 20px;margin-right: 15px;}.wrap{max-width: 800px;margin: 0 auto;}.ui-autocomplete.ui-widget {font-size: 20px;}.heading-color{border-bottom: 4px double;border-color: #00b5ad;margin-bottom: 25px;display: inline-block;}.term-box-style{background: white; padding:10px;margin-bottom: 10px;border-radius: 5px;}.term-box-style h3{margin-top: 0px;}.term-style h2{text-align: center;display: block;margin: 10px;font-size: 24px;margin-top: 25px;}.latest_postnav{list-style: none;padding: unset;}.latest_postnav li{border-bottom: 1px solid #eee;padding-bottom: 5px;margin-bottom: 5px;}.pagination{float: right;}</style>
...
<div class="tab ui active">
    <div class="ui segment">
        <div class="coins_page_headings latest-block-btn">
            ...
            <h1>@lang('v9.DICTIONARY_HEADING')</h1>
