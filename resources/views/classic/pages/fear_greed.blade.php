...
}.is-4{font-size: 24px; float: left;padding: 15px;display: block;clear: both;}
...
.greed-meter hr{margin: 5px;padding: 3px;}
...
<div class="tab ui active">
    <div class="ui segment">
        <div class="coins_page_headings latest-block-btn">
            ...
            <h1>@lang('fear.FEAR_GREED_PAGE')</h1>
...
<div class="tab ui active" style="padding-top: 15px;">
    <div class="ui segment">
        <div class="coins_page_headings latest-block-btn">
            <div class="ui teal large ribbon label"><i class="tag icon"></i></div>
            <h1>@lang('fear.FEAR_GREED_MAP_TITLE')</h1>
...
<div class="tab ui active" style="padding-top: 15px;">
    <div class="ui segment">
        <div class="coins_page_headings latest-block-btn">
            <div class="ui teal large ribbon label"><i class="tag icon"></i></div>
            <h1>@lang('fear.WHY_FEAR_GREED')</h1>
