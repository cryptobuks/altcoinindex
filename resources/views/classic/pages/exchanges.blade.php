...
.img-fluid{height: 180px;border-bottom: 1px solid #eee;}
</style>
@stop
@section('content')
...
<div class="row">
    ...
    <a class="card" href="{{ makeUrl('crypto-exchanges') }}/{{ $exchange->alias }}">      
        <img class="img-fluid" src="{{ $exchange->logo }}" title="{{ $exchange->name }}" alt="{{ $exchange->name }}">
        <div class="card-body">
