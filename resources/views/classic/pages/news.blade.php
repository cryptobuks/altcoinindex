...
<style type="text/css">.news-tags{text-align:center;margin-bottom: 10px;}.news-tags a{color: white;background: black;padding: 2.2px 8px;margin-right: 0.5px;border-radius: 3px;}</style>
@stop
@section('scripts')
                ...
                <ul class="spost_nav" style="padding: 10px;">
                  ...
                  <li style="margin-bottom: 5px;">
                    <div class="media wow fadeInDown">
                      ...
                      <div class="media-body">
                        <a href="{{ URL::to('/crypto-news') }}/{{$news['id']}}/{{$news['alias']}}" class="catg_title">
                          {{ str_limit(strip_tags($news['title']), 58, '...') }}
                        </a> <br />
                        <span class="ui label" style="margin-top: 5px;"><i class="fa fa-clock-o fa-fw" style="font-size: 1em;"></i>{{ date("d M Y", $news['publishedAt']) }}</span>
                      </div>
                    </div>
                ...
                @foreach($the_merkle_news as $news)
                  <li style="margin-bottom: 5px;">
                    <div class="media wow fadeInDown">
                      ...
                      <div class="media-body">
                        <a href="{{ URL::to('/crypto-news') }}/{{$news['id']}}/{{$news['alias']}}" class="catg_title">
                          {{ str_limit(strip_tags($news['title']), 80, '...') }}
                        </a> <br />
                        <span class="ui label" style="margin-top: 5px;"><i class="fa fa-clock-o fa-fw" style="font-size: 1em;"></i>{{ date("d M Y", $news['publishedAt']) }}</span>
                      </div>
                    </div>
