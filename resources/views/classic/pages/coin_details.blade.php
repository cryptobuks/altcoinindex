        ...
        <div class="row">
            <div class="four wide column detail-page-market-stats">
                <div class="ui mini statistic">
                    <div class="label">@lang('tbl_headings.24h_VOLUME')</div><span id="dailyHigh" class="value price-fiat">@if($market->price_usd > 0){{ number_format(($market->volume_usd_day/$market->price_usd)*$market->price_btc) }} BTC @else N/A @endif</span></div>
            </div>
            <div class="four wide column">
                <div class="ui mini statistic">
