  ...
  <div class="row">
    <div class="col-lg-8"><div class="ui segment news">
      ...
      <div class="slider_articles">
        <p style="font-size: 16px;text-align: justify;">{{ strip_tags($crypto_news->description) }}</p>
      </div>
            ...
            <li style="margin-bottom: 10px;">
              <div class="media"> 
                ...
                <div class="media-body"> 
                  ...
                  <span class="ui label"><i class="fa fa-clock-o fa-fw"></i>{{ date("Y-m-d", $news['publishedAt']) }}</span>
                </div>
              </div>
            </li>
            @endforeach
              ...
              <li style="padding: 10px;">
                <div class="media wow fadeInDown"> 
                  ...
                  <div class="media-body"> 
                    ...
                    <span class="ui label"><i class="fa fa-clock-o fa-fw"></i>{{ date("d M Y", $news['publishedAt']) }}</span>
                  </div>
                </div>
              </li>
              @endforeach
