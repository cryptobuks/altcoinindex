        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class="huge">{{{ $crypto_globals['bitcoin_percentage_of_market_cap'] or '0' }}}%</div>
                        <div>@lang('v6.BITCOIN_SHARE')</div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
            ...
            <div class="panel-body">
                ...
                @if($news_data)    
                    ...
                    <div class="news">
                        ...
                        <img alt="{{$news['title']}}" title="{{$news['title']}}" src="{{ URL::asset('public/storage/' .  $news['urlToImage']) }}" width="105" height="100" style="float: left;margin-right: 10px;">
                        @else
                        ...
                        <p>
                            ...
                            @lang('headings.PUBLISHED_AT'): {{ date("Y-m-d", $news['publishedAt']) }}
                        </p>
                    </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="chat-panel panel panel-default">
            ...
            <div class="panel-body form-section" style="min-height: 586px;">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding: 25px;">
                        ...
                        <div class="dashboard-active-icos">
                            <a href="{{ makeUrl('crypto-ico') }}/{{ $ico->alias }}" title="{{ $ico->name }}">
                                <div style="float: left;">
                                    ...
                                    <img alt="{{ $ico->name }} ico" title="{{ $ico->name }} ico" src="{{URL::asset('public/storage/' . $ico->image)}}" height="30" style="border: 1px solid #ddd;border-radius: 25px;">
                                    @elseif($ico->coin_image != '' && file_exists('public/images/coins_icons/' . $ico->coin_image))
                                    <img alt="{{ $ico->name }} ico" title="{{ $ico->name }} ico" src="{{URL::asset('public/images/coins_icons/' . $ico->coin_image)}}" height="30" style="border: 1px solid #ddd;border-radius: 25px;">
                                    @else
                                    <img alt="{{ $ico->name }} ico" title="{{ $ico->name }} ico" src="{{URL::asset('public/images/default_coin.png')}}" height="30" style="border: 1px solid #ddd;border-radius: 25px;">
                                    @endif
                                </div>
                                <div>
                                    <p style="font-size: 18px;margin-left: 35px;">{{ str_limit($ico->name, 11) }}</p>
                ...
                <div class="mobile-ico-carousel" style="display: none;">
                    @foreach($icos as $ico)
                        @if(file_exists('public/storage/' . $ico->image) || file_exists('public/images/coins_icons/' . $ico->coin_image))
                            <div class="dashboard-active-icos">
                                <a href="{{ makeUrl('crypto-ico') }}/{{ $ico->alias }}" title="{{ $ico->name }}">
                                    <div style="float: left;">
                                        @if(file_exists('public/storage/' . $ico->image))
                                        <img alt="{{ $ico->name }} ico" title="{{ $ico->name }} ico" src="{{URL::asset('public/storage/' . $ico->image)}}" height="30" style="border: 1ps solid #ddd;border-radius: 25px;">
                                        @elseif($ico->coin_image != '' && file_exists('public/images/coins_icons/' . $ico->coin_image))
                                        <img alt="{{ $ico->name }} ico" title="{{ $ico->name }} ico" src="{{URL::asset('public/images/coins_icons/' . $ico->coin_image)}}" height="30" style="border: 1px solid #ddd;border-radius: 25px;">
                                        @else
                                        <img alt="{{ $ico->name }} ico" title="{{ $ico->name }} ico" src="{{URL::asset('public/images/default_coin.png')}}" height="30" style="border: 1ps solid #ddd;border-radius: 25px;">
                                        @endif
                                    </div>
                                    <div>
                                        <p style="font-size: 18px;margin-left: 35px;">{{ str_limit($ico->name, 11) }}</p>
