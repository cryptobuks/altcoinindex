...
.panel {border-top-left-radius: unset;border-top-right-radius: unset;}@media only screen and (min-width: 1650px)  {.news-wrapper {width: 70%; margin: 0 auto;}}@media only screen and (max-width: 1650px)  {.news-wrapper {width: 100%; margin: 0 auto;}}
</style>
@stop
@section('content')
