    ...
    <div class="row">
        ...
        <div class="col-4 col-xl-2 col-lg-2 col-md-3 col-sm-4 mb-3">    
            <a class="card" href="{{ makeUrl('crypto-ico') }}/{{ $ico->alias }}" title="{{ $ico->name }}">  
                ...
                <img class="img-fluid" alt="{{$ico->name}}" title="{{$ico->name}}" src="{{URL::asset('public/storage/' . $ico->image)}}" style="width: 100%;border-bottom: 1px solid #eee;min-height: 287px;" />
                @elseif($ico->coin_image != '' && file_exists('public/images/coins_icons/' . $ico->coin_image))
                <img class="img-fluid" alt="{{$ico->name}}" title="{{$ico->name}}" src="{{URL::asset('public/images/coins_icons/' . $ico->coin_image)}}" style="width: 100%;border-bottom: 1px solid #eee;min-height: 287px;" />
                @else
                <img class="img-fluid" alt="{{$ico->name}}" title="{{$ico->name}}" src="{{URL::asset('public/images/default_coin.png')}}" style="width: 100%;border-bottom: 1px solid #eee;min-height: 287px;" />
                @endif
                <div class="card-body">
