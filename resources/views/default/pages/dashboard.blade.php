...
<script src="{{ URL::asset('public/js/morris-data-default.js') }}"></script>
...
<script src="{{ URL::asset('public/js/custom-js/default/dashboard.js') }}"></script>
...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <div class="chat-panel panel panel-default">
            ...
            <div class="panel-body form-section" style="min-height: 610px;">
