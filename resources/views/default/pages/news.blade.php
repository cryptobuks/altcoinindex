        ...
        <div class="latest_post_container" style="padding: unset; height: unset;">
          <ul class="latest_postnav">
            <form action="{{ makeUrl('crypto-coins-news-search') }}" method="GET">
              ...
              <input class="btn btn-primary" type="submit" value="@lang('v9.SEARCH')" style="border-radius: 5px;">
            </form>
          </ul>
        </div>
      </div>
