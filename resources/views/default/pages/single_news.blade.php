...
.box-header {background-color: #337ab7;padding: 10px;color: white;border-radius: 5px;}
...
.hr{border: 1px solid #ccc;clear: both;}.author a {color: white !important;}.single_iteam img {max-height: 650px;}.single-page-news li {width: 100%;}@media only screen and (min-width: 1650px)  {.news-wrapper {width: 70%; margin: 0 auto;}}@media only screen and (max-width: 1650px)  {.news-wrapper {width: 100%; margin: 0 auto;}}
@media only screen and (min-width: 767px) {
.single-page-news li {width: 50%;}
}.h1, .h2, .h3, h1, h2, h3 {margin-top: unset;margin: unset;padding: unset;}
.box-header {background-color: #337ab7;padding: 10px;color: white;}.box-header h3 {font-size: 18px;}a {text-decoration: none !important;}
</style>
@stop
@section('scripts') 
