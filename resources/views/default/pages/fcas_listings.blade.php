...
<div class="tab ui active">
    <div class="ui segment latest-block-btn">
        <div class="coins_page_headings">
            ...
            <!-- <a href="{{ makeUrl('page/crypto-asset-score') }}" style="float: right;vertical-align: middle; font-size: 15px;margin-top: 5px;">@lang('v9.WHAT_IS_FCAS')</a> -->
        </div>
        <div class="ui divider"></div>
        <p>@lang('v9.FCAS_DESC')</p>
    </div>
    <div class="row">
