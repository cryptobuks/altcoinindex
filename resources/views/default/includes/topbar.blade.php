<ul class="nav navbar-top-links" style="display: none;border-bottom: 1px solid #ddd;">
    <li style="border-left: 1px solid #ccc;">
        <a class="@if(Request::is(['*/currencies'])) active @endif" href="{{ makeUrl('/currencies') }}">
            <i class="fa fa-money fa-fw"></i> <br />@lang('v7.CURRENCIES')
        </a>
    </li>
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="divider"></li>
            <li>
                <a href="{{ makeUrl('fundamental-crypto-asset-score') }}" @if(Request::is('*/fundamental-crypto-asset-score')) class="active" @endif>
                    <i class="fa fa-spinner fa-fw"></i> @lang('v9.ASSET_SCORE')
                </a>
            </li>
            <li class="divider"></li>
            <li>
                <a href="{{ makeUrl('block-explorer') }}" @if(Request::is('*/block-explorer')) class="active" @endif>
                    <i class="fa fa-bitcoin fa-fw"></i> @lang('menu.BLOCKEXPLORER')
                </a>
            </li>
            @foreach($pages as $page)
              @if($page->slug !== 'crypto-asset-score')
              <li class="divider"></li>
              <li style="float: unset;padding: unset;">
                  <a title="{{ $page->title }} " href="{{ makeUrl('page') }}/{{  $page->slug }}"><i class="fa fa-angle-double-righ fa-fw"></i> {{ $page->title }}</a>
              </li>
              @endif
            @endforeach
        </ul>
