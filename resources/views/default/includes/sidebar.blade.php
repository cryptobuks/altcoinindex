        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="{{ makeUrl('currencies') }}" @if(Request::is('/currencies')) class="active" @endif>
                    <i class="fa fa-video-camera fa-fw"></i> @lang('v7.CURRENCIES')
                </a>
            </li>
            <li>
                <a href="{{ makeUrl('defi') }}" @if(Request::is('/defi')) class="active" @endif>
            ...
            <li>
                <a title="@lang('fear.FEAR_GREED_MENU')" href="{{ makeUrl('fear-and-greed-index') }}" @if(Request::is('/fear-and-greed-index')) class="active" @endif>
                    <i class="fa fa-bell-o"></i> @lang('fear.FEAR_GREED_MENU') 
                </a>
            </li> 
            <li>
            ...
            <li>
                <a href="{{ makeUrl('block-explorer') }}" @if(Request::is('*/block-explorer')) class="active" @endif>
                    <i class="fa fa-fw fa-bitcoin"></i> @lang('menu.BLOCKEXPLORER')
                </a>
            </li>
            <li>
                <a href="{{ makeUrl('crypto-dictionary') }}" @if(Request::is('*/crypto-dictionary')) class="active" @endif>
                    <i class="fa fa-fw fa-book"></i> @lang('v9.DICTIONARY')
                </a>
            </li>
            <li>
                <a href="{{ makeUrl('fundamental-crypto-asset-score') }}" @if(Request::is('*/fundamental-crypto-asset-score')) class="active" @endif>
                    <i class="fa fa-fw fa-spinner"></i> @lang('v9.ASSET_SCORE')
                </a>
            </li>
            <li>
